        ...
        <table className="w-full text-left border-collapse table-fixed">
          <thead className="w-40">
            <tr className="border-b border-base-border text-base-label text-xs uppercase tracking-wider bg-base-sidebar/40">
              ...
              <th className="py-4 px-5 font-semibold w-30">Nome do Cliente</th>
              <th className="py-4 px-5 font-semibold w-24">Whatsapp</th>
              <th className="py-4 px-5 font-semibold w-24">Tatuador</th>
              <th className="py-4 px-5 font-semibold">Estilo da Tattoo</th>
              <th className="py-4 px-5 font-semibold w-26">Preço</th>
              <th className="py-4 px-5 font-semibold w-30">Status</th>
              ...
              >
                ...
                <td className="py-4 px-5">
                  ...
                  >
                    ...
                    />
                    <span className="underline decoration-base-border hover:decoration-base-success">
                      Chamar
                    </span>
                  </a>
                </td>
                ...
                <td className="py-4 px-5 text-base-text italic">
                  {item.descriptionTattoo}
                </td>
                  ...
                  <span
                    className={`px-2.5 py-0.5 rounded-full text-xs font-medium border ${
                      item.status === "Confirmado"
                        ? "bg-base-success/10 text-base-success border-base-success/20"
                        : item.status === "Pendente"
                          ? "bg-base-alert/10 text-base-alert border-base-alert/20"
                  ...
                  <div className="flex justify-between">
                    ...
                    <div>
                      <button
                        ...
                        title="Cancelar Sessão"
                        className="inline-flex items-center justify-center p-2 bg-base-sidebar hover:bg-base-error/10 text-red-500 hover:text-red-500 border border-base-border hover:border-red-500/20 rounded-lg transition-all duration-200"
                      >
                        <TrashIcon size={16} />
                      </button>
                    </div>
