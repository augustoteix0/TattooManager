    ...
    <Table>
      ...
      <TableBody>
        {dados.map((invoice) => {
            ...
            const howLongTime = formatDistanceToNow(new Date(invoice.dateTattoo))

            return(
          <TableRow key={invoice.id}>
            <TableCell className="font-medium">{invoice.clientName}</TableCell>
            <TableCell>{invoice.dateTattoo  }</TableCell>
            <TableCell>{howLongTime}</TableCell>
            <TableCell className="text-right">
                <a href={`https://api.whatsapp.com/send?phone=${invoice.phoneClient}&text=E%20a%C3%AD,%20${invoice.clientName}!%20Beleza,%20irm%C3%A3o?%20Cara,%20tava%20organizando%20uns%20flashes%20e%20ideias%20de%20desenhos%20novos%20aqui%20no%20est%C3%Badio%20hoje%20e%20lembrei%20de%20ti.%20Faz%20uma%20cara%20que%20voc%C3%AA%20n%C3%A3o%20brota%20aqui%20para%20mandar%20uma%20tinta%20na%20pele,%20n%C3%A9?%20Como%20%C3%A9%20que%20t%C3%A1%20aquela%20sua%20%C3%BAltima%20tattoo,%20curtiu%20o%20resultado%20final%20depois%20de%20100%25%20cicatrizada?%20Inclusive,%20se%20tiver%20pensando%20em%20rabiscar%20mais%20alguma%20coisa%20ou%20fechar%20algum%20projeto%20que%20ficou%20na%20gaveta,%20d%C3%A1%20um%20salve%20aqui%20pra%20gente%20trocar%20uma%20ideia%20sem%20compromisso!`}>Chamar</a>
            </TableCell>
          </TableRow>
            )
})}
